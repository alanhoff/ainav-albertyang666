<div align="center">
  ...
  <p><strong>精选全球优质 AI 工具 | 523+ AI 服务 | 16 大分类 | 5 种语言</strong></p>
...
- ✅ **SEO 友好分页** - 路径式分页（`/tools/page/2`），URL 更简洁，更利于爬虫抓取
- ✅ **响应式分页** - 根据屏幕宽度自适应显示更多或更少的页码
