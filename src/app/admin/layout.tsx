...
import { LayoutDashboard, MessageSquare, Bot, FileText, Menu, X, LogOut, ExternalLink, ShieldAlert, ChevronRight, Mail, Users, Inbox, Languages } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/admin/translations', label: '翻译管理', icon: Languages },
